    ...
    public partial class GeneralTracePropertiesControl : UserControl
    {
        ...
        private void AddPasswordBindingToSettings()
        {
            if (savePasswordCheckBox.Checked)
                passwordTextBox.DataBindings.Add(new System.Windows.Forms.Binding("Text", global::SQLTrace.Properties.Settings.Default, "Password", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
            else
            {
